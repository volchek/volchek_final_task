	...
	<form action="../Controller" method="post"
		...
		<div class="personal-info">
			...
			<label><c:out value="${birthday}" />* <br> <input
				...
				max="2011-01-01" value="<c:out value="${sessionScope.current_user.birthday}" />"> </label> <br> <label><c:out
			...
			<label><c:out value="${email}" />* <br> <input
					...
					pattern="^.+@.+\.[a-zA-Z]+$" id="first-email" required> </label><br>
			<label><c:out value="${email_2}" /> <br> <input
					type="email" name="second-email" placeholder="user@example.com"
					pattern="^.+@.+\.[a-zA-Z]+$" id="second-email" > </label><br> 
			<label><c:out value="${image}" /><br> <input type="url"
				name="avatar" value="<c:out value="${sessionScope.current_user.avatar}" />"> </label>
		</div>
